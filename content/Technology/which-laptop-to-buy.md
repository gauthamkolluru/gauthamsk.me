...
And my computer got ready with an improved bootup time and application start time as my Disk utilization has then got down thereby improving the overall performance.
...
<!-- This means that I have spent significant time with all the 3 major OSs on the planet like MacOS, Linux and Windows. -->
